				...
				<div className='bg-lightgrey container'>
					...
					<div className='bg-logoblue text-center text-white d-flex justify-content-around flex-col p-5 col-lg-12'>
						<div className='col-md-4'>
							<h3 className='text-light'>Industry</h3>
							<p>Medfusion</p>
						</div>
						<div className='col-md-4 border-block'>
							<h3 className='text-light'>BUSINESS OBJECTIVE</h3>
							<p className='px-2'>
					...
					<div className='p-5'>
						...
						<p className='lineHeight-24'>
							<ul>
								<li>
									Medfusion was already using Jira service desk as their ticketing tool and Jenkins
									for their CI/CD.
								</li>
								<li>
									We designed a complete business process in Jira in aggregation with some automation
									task in Jenkin.
								</li>
								<li>
									When the development team sends an email or raise a service desk request, the
									service desk tickets gets automatically created.
								</li>
								<li>
									Then the admin would approve the request and on approval, the Jenkin job engine
									would trigger a provisioning job.
								</li>
								<li>
									Once the job is successful, job engine will notify Jira about the completion along
									with resource details.
								</li>
								<li>
									Then the ticket status is changed automatically and the customer gets the
									acknowledgment through email about the completion.
								</li>
							</ul>
						</p>
