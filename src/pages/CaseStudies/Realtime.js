					...
					<div className='p-5'>
						...
						<p className='lineHeight-24'>
							<ul>
								...
								<li>
									Visibility on certain key metrics is the prime factor that reliance Jio achieved
									through our real-time monitoring services.
								</li>
								<li>
									Knowing the workflow orchestration of their applications widened their business
									payoffs in a short span of time.
								</li>
							</ul>
						</p>

						<p className='lineHeight-24'>
							<b>How did we handle the problem and customized a tool for better visibility?</b>
							<br />
