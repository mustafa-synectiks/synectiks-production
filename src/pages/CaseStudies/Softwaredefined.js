				...
				<div className='bg-lightgrey container'>
					<div className='d-flex mt-5 justify-content-around align-items-center flex-col text-center'>
						<div className='w-40 pt-5 pb-3'>
							<img src={lc} width='100%' alt='Software Defined Transformation' />{' '}
						</div>
					</div>
					<div>
					...
					<div className='p-5'>
						...
						<p className='lineHeight-24'>
							...
							monitoring and security. Most of the products were licensed.
							<br />
						...
						<p className='lineHeight-24'>
							<ul>
								...
								<li>
									We provided a centralized source, valid data and advanced data governance
									technology.
								</li>
								<li>
								...
								<li>
									We proved our expertise once again by delivering fast and accurate releases to meet
